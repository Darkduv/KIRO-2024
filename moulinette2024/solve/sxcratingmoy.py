...
def solve(instance: Instance):
    ...
    #sxc_maxi = max(lll, key=lambda sxc: sxc.rating*(1-sxc.probability_of_failure))
    sxc_maxi = max(lll, key=lambda sxc: (sxc.rating*(1-sxc.probability_of_failure), -sxc.variable_cost, -sxc.fixed_cost))
